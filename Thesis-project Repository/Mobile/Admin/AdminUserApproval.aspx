<%@ Page Title="" Language="C#"MasterPageFile="~/Mobile/Admin/MobileAdmin.Master"  AutoEventWireup="true" CodeBehind="AdminUserApproval.aspx.cs" Inherits="Thesis_project_Repository.Mobile.Admin.AdminUserApproval" %>
            ...
            <asp:GridView ID="approvalwaitinglist" CssClass="table table-hover table-striped"  runat="server" AutoGenerateColumns="False" DataSourceID="approvalList" DataKeyNames="username" AllowSorting="True" AllowPaging="true">
                <Columns>
                    ...
                    <asp:BoundField DataField="acctype" HeaderText="Type" SortExpression="acctype" />
                      <asp:HyperLinkField DataNavigateUrlFields="username, acctype" DataNavigateUrlFormatString="AdminUserApproval.aspx?username={0}&acctype={1}" Text="Approve" />
                </Columns>
            </asp:GridView>
