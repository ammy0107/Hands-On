...
namespace Thesis_project_Repository
{
    public class DatabaseMethods
    {
        ...
        public int UpdateAuthentication( string username, int randomNumber)
        {
            var result = 0;
            const string query = "UPDATE AUTHENTICATION SET " +
            ...
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                command1.Parameters.AddWithValue("@RANDOMNUMBER", randomNumber);
        ...
        public int DisableAuthentication(string username)
        {
            var result = 0;
            const string disableQuery = "Delete from authentication where username = @username;";
                       
            using (var connection = new SqlConnection(ConnectionString))
            {
                var command = new SqlCommand(disableQuery, connection);
        ...
        public int EnableAuthentication(string username, string method)
        {
            const string connectionString =
                "Data Source=itksqlexp8;Initial Catalog=it485project;MultipleActiveResultSets=true;" +
                "Integrated Security=true";
            const string query = "INSERT INTO AUTHENTICATION (USERNAME, AUTHENTICATE, METHOD) VALUES (@USERNAME, 'Y', @METHOD);";
